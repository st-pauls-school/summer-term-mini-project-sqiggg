...
#endif
{
    addParameter(saturationParameter = new AudioParameterFloat("saturation", "Saturation Amount", 0, 1, 0));
    addParameter(gainParameter = new AudioParameterFloat("gain", "Gain Amount", 1, 5, 1));
}
...
//==============================================================================
const String SpectrogramAudioProcessor::getName() const
{
...
const String SpectrogramAudioProcessor::getProgramName (int index)
{
    return {};
}

void SpectrogramAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void SpectrogramAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
    ...
    for (int channel = 0; channel < totalNumInputChannels; ++channel)
    {
        ...
        {
            channelData[sample] = *saturationParameter * cbrtf(channelData[sample]) + channelData[sample] * (1-*saturationParameter);
...
AudioProcessorEditor* SpectrogramAudioProcessor::createEditor()
{
    return new SpectrogramAudioProcessorEditor (*this);
}

//==============================================================================
void SpectrogramAudioProcessor::getStateInformation (MemoryBlock& destData)
{
